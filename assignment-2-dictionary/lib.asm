...
print_error:
    mov rsi, rdi
    mov rdi, ERROR_STREAM_DESCRIPTOR
    jmp print
...
;  Входные данные: дескриптор и строка
;  Принимает дискриптор и печатает в него строку
print:
    mov rdx, rsi
    push rdi
    push rsi
